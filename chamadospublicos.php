    ...
    <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <div>
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="chamadospublicos.php">Chamados públicos</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="config-layout">
            <main class="col-lg-8 p-2" id="dashboard"><!-- Começo da dashboard-->
                    <header>
                            <h2>Chamados públicos</h2>
                            <p class="hero w-75 lh-1">
                                Abra chamados públicos quando  acreditar ser útil compartilhar 
                                problemas que demais colegas também possam viar a ter.
                            </p>
                    </header>
                    <main>
                        <div class="row d-flex justify-content-center config-responsivo">
                          
                            <?php foreach($chamados as $chamado){ ?>
                                <?php  $chamado_dados = explode('#', $chamado); 
                                    if (isset($chamado_dados[3])) {
                                        $tipo_chamado = $chamado_dados[3];
                                    } else {
                                        $tipo_chamado = 'Tipo não especificado';
                                    }
                                    if ($_SESSION['perfil_id'] == 1) {
                                        // Se o usuário for administrador, ele pode ver todos os chamados.
                                    } elseif ($tipo_chamado == 'Público') {
                                        // Se o usuário for regular, ele pode ver seus próprios chamados e chamados públicos.
                                    } else {
                                        // Exiba informações de depuração para entender melhor o problema
                                        continue; // Pular os outros chamados que não atendem às condições acima.
                                    }
                            ...
                            <div class="col-sm-6 card-meus-chamados">
                                ...
                                <span class="badge bg-purple"><?= $chamado_dados[0]; ?></span>
