...
<head>
    ...
    <link rel="stylesheet" href="scss/dashboard/funcionarios/funcionarios2.css">
            ...
            <main class="col-lg-8 p-2" id="dashboard"><!-- Começo da dashboard-->
                    ...
                    <main>
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-4 col-sm-6 card-meus-chamados p-0">
                                <div class="d-flex justify-content-center mb-0 mt-2 pb-0">
                                    <div class="container-foto-funcionarios d-flex justify-content-center">
                                        <img src="imgs/Peter-perfil.png" alt="" srcset=""class="foto-funcionarios">
                                    </div>
                                </div>
                                <div class="d-block lh-1 text-center p-0 m-0">
                                <h6 class="p-0 m-0">Peter Paz</h6>
                                <p class="p-0 m-0 p-cargo-funcionarios">Suporte</p>
                                </div>
                                ...
                                <div class="about-funcionarios m-0 p-0 ps-2">
                                        ...
                                        <div class="content-gmail p-0 m-0">
                                            <p class="p-0 m-0 pb-1 text-decoration-underline">adm.corp@genius.com</p>
                                        </div>
                                        ...
                                        <div class="content-gmail p-0 m-0">
                                            <p class="p-0 m-0 pb-1">7 de junho</p>
                                        </div>
                                        <div class="gmail">
                                            <div class="icon-button-secundario me-2">
                            ...
                            <div class="col-lg-4  col-md-4 col-sm-6 card-meus-chamados p-0">
                                <div class="d-flex justify-content-center mb-0 mt-2">
                                    <div class="container-foto-funcionarios d-flex justify-content-center">
                                        <img src="imgs/jacobet-perfil.png" alt="" srcset=""class="foto-funcionarios">
                                    </div>
                                </div>
                                <div class="d-block lh-1 text-center">
                                    <h6 class="p-0 m-0">Jacobet Terrie</h6>
                                    <p class="p-0 m-0 p-cargo-funcionarios">Estágiario</p>
                                </div>
                                <div class="line-card-meus-chamados"></div>
                                <div class="about-funcionarios m-0 p-0 ps-2">
                                        ...
                                        <div class="content-gmail p-0 m-0">
                                            <p class="p-0 m-0 pb-1 text-decoration-underline">estagiario.corp@genius.com</p>
                                        </div>
                                        ...
                                        <div class="content-gmail p-0 m-0">
                                            <p class="p-0 m-0 pb-1">19 de novembro</p>
                                        </div>
                                        <div class="gmail">
                                            <div class="icon-button-secundario me-2">
                                                <i class="fa-solid fa-house"></i>
