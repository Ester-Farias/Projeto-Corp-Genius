                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="name" name="titulo" class="form" id="exampleFormControlInput1" maxlength="28" placeholder="Título do chamado" required>
                                    </div>

                                    <label for="exampleFormControlInput1" class="form-label">Categoria:</label>
                                    <select class="form"  name="categoria" aria-label="Default select example"  required>
                                    ...
                                    <div class="mt-3">
                                    <label for="exampleFormControlInput1" class="form-label" required>Publicar chamado como:</label>
                                        <div class="d-flex">
                                            <input class="form-check-input me-1" type="radio"  name="pp"  id="publico" value="Público">
                                            <label class="form-check-label label-radio me-5" for="publico">
                                                Público
                                            </label>
                                    
                                            <input class="form-check-input me-1" type="radio"  name="pp"  id="privado" value="Privado" checked required>
                                ...
                                <div class="col-12 col-lg-6 mt-4 mt-sm-0">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form"  name="descricao" id="exampleFormControlTextarea1" rows="3" maxlength="180" required></textarea>
                                    </div>
                                </div>
